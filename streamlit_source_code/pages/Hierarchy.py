...
if 'connect' not in st.session_state:
    ...
    if st.session_state['connect']==True:
        ...
        st.markdown('''<h2 style='color:#C71585;font-family: Rockwell;text-align: center;'>Role Hierarchy... <img src="https://cdn-icons-png.flaticon.com/128/3286/3286746.png" style='width:70px;height:50px'/></h2>''',unsafe_allow_html=True)
